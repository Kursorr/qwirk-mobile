<template>
  <StackLayout class="server">
    <FlexboxLayout
      :class="[scrollY > 0 ? 'serverInfo addBorder' : 'serverInfo']"
    >
    ...
    >
      <StackLayout padding="0">
        <StackLayout
          v-for="(category, index) in server.categories"
          padding="0"
          :key="index"
          class="chan"
        >
          <FlexboxLayout alignItems="center" marginBottom="10">
            <Label
              :text="String.fromCharCode($icons.chevronDown)"
              class="ico down"
            />
          ...
          <FlexboxLayout
            ...
            :class="[
              currentChannelId === index && currentChannelName === channel.name
                ? 'channels selected'
                : 'channels',
            ]"
          >
            <Label
              :text="String.fromCharCode($icons.hashtag)"
              class="ico hashtag"
              marginRight="5"
            />
